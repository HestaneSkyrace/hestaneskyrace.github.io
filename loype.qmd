...
7. Nedstigning i ura på vestsida, vidare langs T-merka sti tilbake til Skaraly mot Kvamsstølen og tilbake til Yndestadstølen.
8. Siste etappe går samme veg tilbak frå Yndestadstølen via Hjelmelandsstølen og Djupedalen til Langeland.
...
Det er stasjonar for påfyll av drikke undervegs, men det er òg gode alternativer til å fylle på med naturleg vatn enkelte stader i løypa. Oversikta under viser kor du finn dei.

| Distanse | Stad | Merknad |
|---|---|---|
| **~6 km** | Hjelmelandsstølen | Første stasjon for påfyll. Sjølv om du ikkje er tom, er det lurt å fylle opp her — det er lite drikkevatn vatn å fylle før Lisjehesten. |
...
| **~27 km** | Hjelmelandsstølen | Siste stasjon for påfyll før mål. |
...
(function(){
  ...
  var mkrs=[
    {lat:61.39431, lon:5.80477, label:'🏁 Start / Mål', color:'#22c55e'},
    {lat:61.40961, lon:5.68249, label:'⛰️ Lisjehesten (915 m)', color:'#8b5cf6'},
    {lat:61.40553, lon:5.65053, label:'🔵 Skaraly', color:'#3b82f6'},
    {lat:61.40216, lon:5.64600, label:'🔴 Egga', color:'#ec383c'},
    {lat:61.40139, lon:5.62735, label:'⛰️ Storehesten (1202 m)', color:'#f59e0b'}
  ];
  mkrs.forEach(function(mk){
    L.circleMarker([mk.lat, mk.lon], {
      radius:7, color:'#fff', fillColor:mk.color,
      fillOpacity:1, weight:2
    }).bindTooltip(mk.label, {permanent:false, direction:'top'}).addTo(m);
  });
})();
</script>
  </div>
  ...
  <div class="alt-route">
    <div class="alt-route__header">
      ...
      <span class="alt-route__tag alt-route__tag--weather">Utfordrande vær — Utan Egga</span>
    </div>
    <div class="alt-route__stats">
      <span>34 km</span><span>~1820 hm</span>
    </div>
    <p>Vert brukt ved utfordrande vær og glatt i Egga. Løypa går tur-retur Storehesten på stien ein normalt spring ned (vestsida). Merk: ved svært dårleg sikt kan løypevakt gi beskjed om at ein snur før toppen av Storehesten.</p>
...
(function(){
  ...
  <div class="alt-route">
    ...
    <p>Vert brukt når elva i skaret er for stor til å passere trygt, og Egga er glatt. Løypa følgjer alternativ sti på sørsida nedafor ryggen til Lisjehesten, tur-retur Lisjehesten på ned-stien, og tur-retur Storehesten via vestsida (utan Egga).</p>
...
(function(){
  ...
  <div class="alt-route">
    <div class="alt-route__header">
      ...
      <span class="alt-route__tag alt-route__tag--water">Svært krevjande forhold — utan skaret og Egga</span>
    </div>
    <div class="alt-route__stats">
      <span>32,5 km</span><span>~1530 hm</span>
    </div>
    <p>Same omlegging som alternativ 3 for Lisjehesten (utan skaret), og utan Storehesten ved å snu på Vardehaugane.</p>
